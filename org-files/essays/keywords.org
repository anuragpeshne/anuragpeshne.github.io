...
** Word Count
   ...
   Vim scripts[fn:2], it was clear that I was better off searching for scripts for a
   editor which doesn't place much logic into its syntax files or which are easily
